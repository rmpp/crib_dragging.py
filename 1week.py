...
ciphertext_target = "32510ba9babebbbefd001547a810e67149caee11d945cd7fc81a05e9f85aac650e9052ba6a8cd8257bf14d13e6f0a803b54fde9e77472dbff89d71b57bddef121336cb85ccb8f3315f4b52e301d16e9f52f904"
...
def main():
	...
	ciphertext_number = raw_input("Please select the ciphertext to be XORed with the ciphertext_target:")
	
	# Unhexlify:convert hex in ascii
	
	# C1 xor CT = x = m1 xor mt
	xor1 = strxor(unhexlify(ciphertexts[int(ciphertext_number) -1]),unhexlify(ciphertext_target))
